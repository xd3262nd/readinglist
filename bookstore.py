...
class Book:
    ...
    def save(self):
        """ Save or update book object in the program.
            If there is an id in the book object, this function will update the book object.
            Else, a new book object will be created and added to the book list. """
        if self.id:
